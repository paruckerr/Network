...
//  Network
//
//  Created by Eduardo Parucker on 28/10/14.
...
struct Current {
    ...
    init(weatherDictionary: NSDictionary) {
        ...
        precipProbability = currentWeather["precipIntensity"] as Double
    ...
    func dateStringFromUnixTime(unixTime: Int) -> String {
        ...
        let stringDate = dateFormatter.stringFromDate(weatherDate)
